...
PyObject *PyIMAPISession::AdminServices(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    unsigned long  _arg0 = 0;
    IMsgServiceAdmin ** _arg1;
...

{
  _arg1 = &temp;
	...
	IMAPISession *_swig_self;
	if ((_swig_self=GetI(self))==NULL) return NULL;
    if(!PyArg_ParseTuple(args,"|l:AdminServices",&_arg0)) 
        return NULL;
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )_swig_self->AdminServices(_arg0,_arg1);
...
{
	MAKE_OUTPUT_INTERFACE(_arg1, _resultobj, IID_IMsgServiceAdmin)
}
    return _resultobj;
}

static PyMethodDef IMAPISessionMethods[] = {
	 { "AdminServices", PyIMAPISession::AdminServices, 1 },
