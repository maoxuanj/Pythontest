...
static PyObject *_wrap_HrThisThreadAdviseSink(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    IMAPIAdviseSink * _arg0;
    IMAPIAdviseSink ** _arg1;
    IMAPIAdviseSink * temp;
    PyObject * _obj0 = 0;
    ...
    self = self;
{
  _arg1 = &temp;
    ...
    if(!PyArg_ParseTuple(args,"O:HrThisThreadAdviseSink",&_obj0)) 
        return NULL;
{
	if (!PyCom_InterfaceFromPyInstanceOrObject(_obj0, IID_IMAPIAdviseSink, (void **)&_arg0, 0))
		return NULL;
}
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )HrThisThreadAdviseSink(_arg0,_arg1);
...
{
	MAKE_OUTPUT_INTERFACE(_arg1, _resultobj, IID_IMAPIAdviseSink)
}
{
	if (_arg0) _arg0->Release();
}
...
static PyObject *_wrap_HrDispatchNotifications(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HRESULT  _result;
    ULONG  _arg0;

    self = self;
    if(!PyArg_ParseTuple(args,"l:HrDispatchNotifications",&_arg0)) 
        return NULL;
{
      Py_BEGIN_ALLOW_THREADS
          _result = (HRESULT )HrDispatchNotifications(_arg0);
...
static PyMethodDef mapiMethods[] = {
	 { "HrDispatchNotifications", _wrap_HrDispatchNotifications, 1 },
	 { "HrThisThreadAdviseSink", _wrap_HrThisThreadAdviseSink, 1 },
	 { "HrAllocAdviseSink", PyHrAllocAdviseSink, 1 },
...
/* This code only valid if non COM SWIG builds */
  ...
  PyDict_SetItemString(d, "error", PyWinExc_ApiError);
	...
	ADD_IID(PS_ROUTING_SEARCH_KEY);
	 ...
	 PyDict_SetItemString(d,"MAPI_MOVE", PyInt_FromLong((long) MAPI_MOVE));
	 PyDict_SetItemString(d,"MAPI_NOREPLACE", PyInt_FromLong((long) MAPI_NOREPLACE));
	 ...
	 PyDict_SetItemString(d,"fnevCriticalError", PyInt_FromLong((long) fnevCriticalError));
	 PyDict_SetItemString(d,"fnevNewMail", PyInt_FromLong((long) fnevNewMail));
	 PyDict_SetItemString(d,"fnevObjectCreated", PyInt_FromLong((long) fnevObjectCreated));
	 PyDict_SetItemString(d,"fnevObjectDeleted", PyInt_FromLong((long) fnevObjectDeleted));
	 PyDict_SetItemString(d,"fnevObjectModified", PyInt_FromLong((long) fnevObjectModified));
	 PyDict_SetItemString(d,"fnevObjectMoved", PyInt_FromLong((long) fnevObjectMoved));
	 PyDict_SetItemString(d,"fnevObjectCopied", PyInt_FromLong((long) fnevObjectCopied));
	 PyDict_SetItemString(d,"fnevSearchComplete", PyInt_FromLong((long) fnevSearchComplete));
	 PyDict_SetItemString(d,"fnevTableModified", PyInt_FromLong((long) fnevTableModified));
	 PyDict_SetItemString(d,"fnevStatusObjectModified", PyInt_FromLong((long) fnevStatusObjectModified));
	 PyDict_SetItemString(d,"fnevReservedForMapi", PyInt_FromLong((long) fnevReservedForMapi));
	 PyDict_SetItemString(d,"fnevExtended", PyInt_FromLong((long) fnevExtended));
	 PyDict_SetItemString(d,"TABLE_CHANGED", PyInt_FromLong((long) TABLE_CHANGED));
	 PyDict_SetItemString(d,"TABLE_ERROR", PyInt_FromLong((long) TABLE_ERROR));
	 PyDict_SetItemString(d,"TABLE_ROW_ADDED", PyInt_FromLong((long) TABLE_ROW_ADDED));
	 PyDict_SetItemString(d,"TABLE_ROW_DELETED", PyInt_FromLong((long) TABLE_ROW_DELETED));
	 PyDict_SetItemString(d,"TABLE_ROW_MODIFIED", PyInt_FromLong((long) TABLE_ROW_MODIFIED));
	 PyDict_SetItemString(d,"TABLE_SORT_DONE", PyInt_FromLong((long) TABLE_SORT_DONE));
	 PyDict_SetItemString(d,"TABLE_RESTRICT_DONE", PyInt_FromLong((long) TABLE_RESTRICT_DONE));
	 PyDict_SetItemString(d,"TABLE_SETCOL_DONE", PyInt_FromLong((long) TABLE_SETCOL_DONE));
	 PyDict_SetItemString(d,"TABLE_RELOAD", PyInt_FromLong((long) TABLE_RELOAD));
	 PyDict_SetItemString(d,"MAPI_STORE", PyInt_FromLong((long) MAPI_STORE));
	 PyDict_SetItemString(d,"MAPI_ADDRBOOK", PyInt_FromLong((long) MAPI_ADDRBOOK));
	 PyDict_SetItemString(d,"MAPI_FOLDER", PyInt_FromLong((long) MAPI_FOLDER));
	 PyDict_SetItemString(d,"MAPI_ABCONT", PyInt_FromLong((long) MAPI_ABCONT));
	 PyDict_SetItemString(d,"MAPI_MESSAGE", PyInt_FromLong((long) MAPI_MESSAGE));
	 PyDict_SetItemString(d,"MAPI_MAILUSER", PyInt_FromLong((long) MAPI_MAILUSER));
	 PyDict_SetItemString(d,"MAPI_ATTACH", PyInt_FromLong((long) MAPI_ATTACH));
	 PyDict_SetItemString(d,"MAPI_DISTLIST", PyInt_FromLong((long) MAPI_DISTLIST));
	 PyDict_SetItemString(d,"MAPI_PROFSECT", PyInt_FromLong((long) MAPI_PROFSECT));
	 PyDict_SetItemString(d,"MAPI_STATUS", PyInt_FromLong((long) MAPI_STATUS));
	 PyDict_SetItemString(d,"MAPI_SESSION", PyInt_FromLong((long) MAPI_SESSION));
	 PyDict_SetItemString(d,"MAPI_FORMINFO", PyInt_FromLong((long) MAPI_FORMINFO));
