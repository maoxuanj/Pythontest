...
DC_PATH = "D:/Python/xcd/xe6/xcd/xe6/districtcode.txt"
...
def randomname1():
        ...
        return random.choice(
            ["赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦", "尤", "许",
             ...
             "傅",
             "皮", "卞", "齐", "康", "伍", "余", "元", "卜", "顾", "孟", "平", "黄", "和", "穆", "萧", "尹", "司马", "王沈", "邯郸", "孟",
             "鲍俎", "北海", "南宫", "东方", "北冥", "独孤", "尉迟", "太叔", "申屠", "公孙", "慕容", "仲孙", "钟离", "闻人", "子车", "司徒", "毛",
             "沈",
             "贺", "诸葛", "谢", "陈", "猫", "折", "徐", "姚"]).decode('utf-8') + "" + random.choice(
            ["子璇", "淼", "国栋", "子文", "瑞堂", "甜", "敏", "尚文", "国贤", "贺祥", "晨涛", "昊轩", "易轩", "益辰", "益帆", "益冉", "瑾春",
             "瑾昆", "春齐", "杨", "文昊", "东东", "雄霖", "浩晨", "熙涵", "溶溶", "冰枫", "欣欣", "宜豪", "欣慧", "建政", "美欣", "淑慧", "文轩",
             "文杰", "欣源", "忠林", "榕润", "欣汝", "慧嘉", "新建", "建林", "亦菲", "林", "冰洁", "佳欣", "涵涵", "禹辰", "淳美", "泽惠", "伟洋",
             "涵越", "润丽", "翔", "淑华", "晶莹", "凌晶", "苒溪", "雨涵", "嘉怡", "佳毅", "子辰", "佳琪", "紫轩", "瑞辰", "昕蕊", "萌", "明远",
             "欣宜", "泽远", "欣怡", "佳怡", "佳惠", "晨茜", "晨璐", "运昊", "汝鑫", "淑君", "晶滢", "润莎", "榕汕", "佳钰", "佳玉", "晓庆", "一鸣",
             "语晨", "添池", "添昊", "雨泽", "雅晗", "雅涵", "钰婕", "玄界", "炫杰", "世界", "易", "益栋", "东东", "东", "瑞", "锐", "丽", "青青",
             "方寸", "奶茶", "强东", "小马", "华腾", "雄飞", "取之", "社值", "利民", "复印", "未来", "伊泽", "伊芙", "凯特", "元素", "袁术", "袁绍",
             "数据", "起先", "蔡晨", "采臣", "蔡成", "蔡陈", "蔡城", "蔡盛", "蔡诚", "财称", "裁称", "俞硕", "德鲁", "安德罗尼", "天天", "谋", "螳螂",
             "燕", "凌燕", "燕琳", "艳黎巴嫩", "清妍", "诗悦", "嘉乐", "晨涵", "天赫", "玥傲", "佳昊", "天昊", "萌萌", "若萌"]).decode('utf-8')
