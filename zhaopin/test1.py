...
#打开百度 http://www.baidu.com
    ...
    Select(driver.find_element_by_id("bankDeraler")).select_by_visible_text("工行安徽城建支行")
    ...
    driver.find_element_by_css_selector("input.hide").clear()
    driver.find_element_by_css_selector("input.hide").send_keys(u"C:\\Users\\mxj\\Desktop\\错误捕捉1\\timg：1.jpg")
    driver.find_element_by_css_selector("input.hide").clear()
    sleep(3)
